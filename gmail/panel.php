...
<body>
          ...
          <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <?php } ?>
                    ...
                    <li class="selected"><a href="javascript:;"><i class="fa fa-google"></i> Gmail</a></li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-google"></i> Gmail </h3>
                        </div>
    ...
    $query=$mysqli->query("SELECT * FROM `gmail` WHERE id=(SELECT id FROM usuarios WHERE nick='$xs')");
                $no=1;
